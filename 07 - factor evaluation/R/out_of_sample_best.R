...
dt0 <- readRDS("/home/nazarov/02-fmlab.hse.ru/07 - factor evaluation/results/russia_stocks_result_f0.RDS") # читаем из файла что там есть 
dt1 <- readRDS("/home/nazarov/02-fmlab.hse.ru/07 - factor evaluation/results/russia_stocks_result_f1.RDS") # читаем из файла что там есть 


write.xlsx(dt0[[1]], 
           "/home/nazarov/02-fmlab.hse.ru/07 - factor evaluation/results/result_table_13_05_2016_.xls", sheetName="filter_0")


write.xlsx(dt1[[1]], 
           "/home/nazarov/02-fmlab.hse.ru/07 - factor evaluation/results/result_table_13_05_2016.xls", sheetName="filter_2")
