...
####**Таблица 1. Исследуемые компании ** 
...
####**Рисунок 2. (вертикальные пунктирные линии - начало нового года) ** 
...
####**Таблица 3. Доходности победителей и проигравших для лучшей стратегии** 
```{r, echo=FALSE, results='asis'}
...
####**Рисунок 4. (вертикальные пунктирные линии - начало нового года) ** 
...
####**Таблица 4. Доходности победителей и проигравших для лучшей стратегии** 
```{r, echo=FALSE, results='asis'}
row.names(data.plot2)<-1:nrow(data.plot2)
data.plot2[,2]<-round(data.plot2[,2],4)
data.plot2[,3]<-round(data.plot2[,3],4)
