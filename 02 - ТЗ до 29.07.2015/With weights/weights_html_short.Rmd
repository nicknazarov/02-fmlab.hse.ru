...
## 1. Моментум стратегии при весах (7,6,5,3,2,1,1,2,3,5,6,7)/24. Ранжирование по средней доходности (бенчмарк 6% годовых - только для reality check)
...
datatable(round(result.data[,c(1,2,3,4,5,6,9)],6), filter = 'top',options = list(pageLength = 10, lengthMenu = c( 10, 20, 50, 100, nrow(result.data))) ) 
```
<p>
<br />
<br />
...
## 2.  Моментум стратегии при весах (7,6,5,3,2,1,1,2,3,5,6,7)/24. Ранжирование по t-статистике (бенчмарк 6% годовых - только для reality check)
...
## 3.  Моментум стратегии при весах (7,6,5,3,2,1,1,2,3,5,6,7)/24. Ранжирование по средней доходности (бенчмарк 6% годовых) для компаний с максимальной рыночной капитализацией (всего 32 компании)
...
## 5.  Моментум стратегии при весах (7,6,5,3,2,1,1,2,3,5,6,7)/24. Ранжирование по t-статистике (бенчмарк 6% годовых) для компаний с максимальной рыночной капитализацией (всего 32 компании)
