---
title: "Моментум-стратегии и reality check Россия"
output:
  html_document
lang: russian
---
...
hist(best.strat*100,50,col="gray", labels = TRUE, xlab = "Среднемесячная доходность(%)", ylab = "Количество портфелей", main = "Распределение среднемесячных доходностей лучшей стратегии",ylim = c(0, 300))
...
hist(best.strat*100,50,col="gray", labels = TRUE, xlab = "Среднемесячная доходность(%)", ylab = "Количество портфелей", main = "Распределение доходностей лучшей по t-stat стратегии",ylim = c(0, 300))
