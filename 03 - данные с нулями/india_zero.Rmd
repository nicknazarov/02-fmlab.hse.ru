---
title: "Моментум-стратегии и reality check Китай (данные с нулями)"
output:
  html_document:
      pandoc_args: [
      "+RTS", "-K64m",
...
setwd("/home/nazarov/02-fmlab.hse.ru/03 - данные с нулями/")
library(pander)
library(DT)
...
resultDataFull<- readWorksheet(loadWorkbook("/home/nazarov/02-fmlab.hse.ru/03 - данные с нулями/results/stocks_china.xlsx"),sheet=1)
