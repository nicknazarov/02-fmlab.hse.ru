...
N_mean_max <- (nrow(resultDataFull)-(1+p3_mean_max *4))%/%STEP 
return_with_date <- ret_with_date (p1_mean_max/4 , p2_mean_max , p3_mean_max/4 , STEP, N_mean_max, resultDataFull, UP1, UP2, percent_mean_max) 
return.winner<- ret.winner(p1_mean_max/4 , p2_mean_max , p3_mean_max/4 , STEP, N_mean_max, resultDataFull, UP1, UP2, percent_mean_max) 
return.loser<- ret.loser(p1_mean_max/4 , p2_mean_max , p3_mean_max/4 , STEP, N_mean_max, resultDataFull, UP1, UP2, percent_mean_max) 
...
N_mean_min<- (nrow(resultDataFull)-(1+p3_mean_min*4))%/%STEP 

return_with_date <- ret_with_date (p1_mean_min/4 , p2_mean_min , p3_mean_min/4 , STEP, N_mean_min, resultDataFull, UP1, UP2, percent_mean_min) 
return.winner<- ret.winner(p1_mean_min/4 , p2_mean_min , p3_mean_min/4 , STEP, N_mean_min, resultDataFull, UP1, UP2, percent_mean_min) 
return.loser<- ret.loser(p1_mean_min/4 , p2_mean_min , p3_mean_min/4 , STEP, N_mean_min, resultDataFull, UP1, UP2, percent_mean_min) 
...
N_t <- (nrow(resultDataFull)-(1+p3_t*4))%/%STEP 

return_with_date <- ret_with_date (p1_t/4 , p2_t , p3_t/4 , STEP, N_t, resultDataFull, UP1, UP2, percent_t) 
return.winner<- ret.winner(p1_t/4 , p2_t, p3_t/4 , STEP, N_t, resultDataFull, UP1, UP2, percent_t) 
return.loser<- ret.loser(p1_t/4 , p2_t, p3_t/4 , STEP, N_t, resultDataFull, UP1, UP2, percent_t) 
